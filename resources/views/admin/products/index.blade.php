...
<div class="section-container py-8 md:py-12">
  ...
  <div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-black"><i class="fa-solid fa-box text-stone-700 mr-1.5"></i> Kelola Produk</h1>
      ...
      <tbody class="divide-y divide-stone-100">
        @foreach($products as $p)
          <tr>
            ...
            <td class="p-3">
              {!! $p->is_active
                ? '<i class="fa-solid fa-circle-check text-emerald-500" title="Aktif"></i>'
                : '<i class="fa-solid fa-circle-xmark text-rose-500" title="Non-aktif"></i>'
              !!}
            </td>
